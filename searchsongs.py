...
def searchSong():
    try:
        songName = input("Type a song name (Specify the song band (Recommended)\nInput: ")
        ...
        print(Album)
        distributionDate = driver.find_element(By.XPATH, '//div[11]/div[4]/div[3]/div/div/div[2]/div/div/div/div['
                                                         '1]/div/div/div').text
        print(distributionDate)
        print('---- Lyrics ----')
        driver.find_element(By.XPATH, '//div/div/div/div/div[3]/div[2]/div/div/div[2]/div/div/div/div/div[1]/div['
                                      '2]/div/a').click()
        driver.implicitly_wait(7)
        myButton = driver.find_element(By.XPATH, '//div/div/div[2]/div/div/div/div/div[3]/div[1]/div[1]/div/div/div['
                                                 '1]/div/div')
        Lyrics = driver.find_element(locate_with(By.XPATH, "//div[3]/div[1]/div[1]/div/div/div["
                                                           "2]/div/div/div/div/div[1]/div[2]").below(myButton)).text
        print(Lyrics)
        print('---- Song Info ----')
    except ValueError:
